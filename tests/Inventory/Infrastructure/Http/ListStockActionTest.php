...
final class ListStockActionTest extends WebTestCase
{
    ...
    private function createProduct(string $name, string $pictureUrl = 'https://example.com/p.jpg'): ProductId
    {
        $id = ProductId::generate();
        $this->entityManager->persist(Product::create($id, $name, $pictureUrl));
        $this->entityManager->flush();
